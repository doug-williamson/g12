...
export class TeamsService {
	...
	getTeams$(): Observable<IDynastyYearTeam[]> {
		this.teamCollection = this.firestore.collection<IDynasty>('ncaaf14-dynasty').doc('AGuaX7OQDUU3QHiBQFs5').collection<IDynastyYear>('years').doc('kpqA83Me3r8eT2oLFmje').collection<IDynastyYearTeam>('standings', ref => ref.orderBy('division'));
